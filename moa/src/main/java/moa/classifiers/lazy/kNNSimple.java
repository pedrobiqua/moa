 ...
 * @version 03.2012
 */
public class kNNSimple extends AbstractClassifier implements MultiClassClassifier {

    private static final long serialVersionUID = 1L;

    public IntOption kOption = new IntOption("k", 'k', "The number of neighbors", 1, 1, Integer.MAX_VALUE);
    ...
    // PEGUEI DO KNN NORMAL E RETIREI A REGRESSÃO
    @Override
